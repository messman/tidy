...
// module
exports.push([module.i, ".react-tabs {\n  margin-bottom: 5px; }\n  .react-tabs .tab-titles {\n    display: flex;\n    overflow: hidden; }\n  .react-tabs .tab-title {\n    font-size: 1.3rem;\n    position: relative;\n    border: 1px solid #ddd;\n    border-radius: 5px 5px 0 0;\n    padding: 10px 20px; }\n    .react-tabs .tab-title:not(.tab-active) {\n      cursor: pointer;\n      background-color: #eee;\n      color: #555; }\n  .react-tabs .tab-active {\n    border-bottom: 0;\n    cursor: default;\n    z-index: 5; }\n  .react-tabs .tab-panes {\n    border-bottom: 1px solid #ddd;\n    padding: 5px 2px; }\n", ""]);
...
var Tabs = exports.Tabs = function (_React$Component) {
    ...
    _createClass(Tabs, [{
        ...
        value: function render() {
            ...
            var tabs = Tabs.getChildrenWithPropType(this.props.children, Tab);
            var selected = this.state.selected;
            var tabTitles = tabs.map(function (tab, index) {
                var className = ["tab-title"];
                var onClick = null;
                if (index === selected) {
                ...
                return React.createElement("div", { key: index, className: className.join(" "), onClick: onClick }, tab.props.title);
            });
            var activeTabContent = tabs.filter(function (tab, index) {
                return index === selected;
            });
            return React.createElement("div", { className: "react-tabs" }, React.createElement("div", { className: "tab-titles" }, tabTitles), React.createElement("div", { className: "tab-panes" }, activeTabContent));
        }
    }], [{
        key: "getChildrenWithPropType",
        value: function getChildrenWithPropType(children, parent) {
            return React.Children.map(children, function (child, index) {
                var type = child && child["type"] || null;
                if (type && type === parent) return child;
                return null;
            }).filter(function (tab) {
                return !!tab;
            });
...
var DEFINE = exports.DEFINE = {
    BUILD: {
        IS_PRODUCTION: false,
        TIME: "Wed Jul 18 2018 17:05:39 GMT-0400 (EDT)"
    }
};
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            var view = React.createElement(_components.Tabs, null, React.createElement(_components.Tab, { title: "Players" }, React.createElement("h1", null, "Hello, World!")), React.createElement(_components.Tab, { title: "Options" }, React.createElement("h1", null, "Hello, Worlddd!")));
            return React.createElement("div", { className: "full grid gL-column" }, React.createElement("header", null, React.createElement("h1", null, "brack-it")), React.createElement("main", { className: "gL-flexed grid grid-pad gL-column" }, view));
        }
    }]);
...
//# sourceMappingURL=entry.index.91ebc9ad8e.js.map