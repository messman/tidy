	...
	render() {
		return (
			<div className="info tab-view-bg">
				<header>
					<h2>quick-tides</h2>
					<h3>by Andrew Messier</h3>
				</header>
				<div>
					For Mark and Dawna Messier
				</div>
				<div>
					<a href="https://github.com/messman/quick-tides" rel="noopener noreferrer">
						...
						<p>See the code / note issues</p>
					</a>
				</div>
				<div>
					Big thanks to the U.S. National Oceanic and Atmospheric Administration (NOAA)
				...
				<div>
					<p>Version {DEFINE.BUILD.VERSION} ({DEFINE.BUILD.IS_PRODUCTION ? "Production" : "Debug"})</p>
					<p>Built {DEFINE.BUILD.TIME}</p>
				</div>
			</div>
		);
	}
