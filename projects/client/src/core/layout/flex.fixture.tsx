...
export default {
	...
	'Row Basis': CosmosFixture.create(() => {

		const testWidthOrHeight = 180;
	...
	'Column Basis': CosmosFixture.create(() => {

		const testWidthOrHeight = 100;
		const testText = 'This is some longer text to see if the content will keep going';
