...
// import { Flex, FlexRow } from '@/core/layout/layout';
...
// import { minutes } from '@messman/react-common';
...
// 					</FlexRowMargin>
// 					<FlexRowMargin>
// 						<SpacedIcon type={icon} spacing='default' />
// 						<Paragraph>
// 							{shortStatusText}
// 						</Paragraph>
// 					</FlexRowMargin>
...
// 			</Margin>
// 			{sunBarRender}
// 			<TideChartContainer height={outputHeight}>
// 				{tideChart}
// 			</TideChartContainer>
// 		</div>
// 	);
...
// const DisabledTextInline = styled(Paragraph)`
// 	color: red;
...
// function createPositionedExtremaInfo(events: iso.Tide.TideEvent[], startTime: DateTime, endTime: DateTime): [JSX.Element[], 'space-around' | 'space-between'] {
...
// 			<Center>
// 				<Paragraph>{event.isLow ? 'LOW' : 'HIGH'}</Paragraph>
// 				<div>
